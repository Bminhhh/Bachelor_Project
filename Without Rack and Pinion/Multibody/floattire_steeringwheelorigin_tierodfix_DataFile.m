...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [-49.688150503745177 128.22531552658691 -1106.0756373805691];  % mm
smiData.RigidTransform(7).angle = 1.8427479133345606;  % rad
smiData.RigidTransform(7).axis = [0.98107281210220976 0.19227561340909624 0.022939612943942721];
...
smiData.RigidTransform(8).ID = "RootGround[Steering_wheel_steering_column-1]";
