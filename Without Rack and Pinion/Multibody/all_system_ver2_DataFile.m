...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-1.0164725520525053 6.304691397733281 -284.99804259358973];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [-1.0752173934449729 6.2949390486758716 1183.1534849394034];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [-7.4905955356659746 10.00658842235431 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [-9.8407948456724625e-12 -7.496225862269057e-13 1.5081269566508126e-12];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [0 0 -5.0000000000001155];  % mm
smiData.RigidTransform(7).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(7).axis = [1 0 0];
smiData.RigidTransform(7).ID = "B[Steering_wheel_steering_column-1:-:Tie_rod_components_new-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [-158.68679035203257 1085.9179447584659 -163.94792738756087];  % mm
smiData.RigidTransform(8).angle = 2.059084107246512;  % rad
smiData.RigidTransform(8).axis = [0.53820189812068264 -0.45676691884799636 0.70830974771310473];
smiData.RigidTransform(8).ID = "F[Steering_wheel_steering_column-1:-:Tie_rod_components_new-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(9).translation = [-453.04976591499457 134.4657033776146 -22.751491039238697];  % mm
smiData.RigidTransform(9).angle = 2.511634195780696;  % rad
smiData.RigidTransform(9).axis = [0.60846974235134188 0.66154315316936341 -0.43832092026006236];
smiData.RigidTransform(9).ID = "RootGround[Left_wheel-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(10).translation = [-1161.9040223590914 182.77796627109478 91.453948167870877];  % mm
smiData.RigidTransform(10).angle = 3.0401233088058799;  % rad
smiData.RigidTransform(10).axis = [-0.067030811867012804 -0.74048931267493456 -0.66871701643868164];
...
%This joint has been chosen as a cut joint. Simscape Multibody treats cut joints as algebraic constraints to solve closed kinematic loops. The imported model does not use the state target data for this joint.
smiData.SphericalJoint(1).S.Pos.Angle = 111.28613819392612;  % deg
smiData.SphericalJoint(1).S.Pos.Axis = [0.55137586556936591 0.55672144001111878 -0.6213259153613172];
