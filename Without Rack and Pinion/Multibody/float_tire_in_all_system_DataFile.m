...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-1.016472552053699 6.3046913977333361 -284.99804259358007];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [-1.0752173934461098 6.2949390486760137 1183.1534849394131];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [-158.68679035202976 1085.9179447584661 -163.94792738756269];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [1.9911400581120129 6.8759668236707236 10.246817791006899];  % mm
smiData.RigidTransform(7).angle = 1.9423095233134269;  % rad
smiData.RigidTransform(7).axis = [-0.55137586556936591 -0.55672144001111878 0.6213259153613172];
smiData.RigidTransform(7).ID = "SixDofRigidTransform[Tie_rod_components_new-1]";
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 3.4835755327359039;  % kg
smiData.Solid(4).CoM = [-0.00019534318850639794 6.5427535385087374 -245.30870086279435];  % mm
smiData.Solid(4).MoI = [462416.23721934948 464811.18256359041 29054.610542008548];  % kg*mm^2
smiData.Solid(4).PoI = [-5573.5035822310983 0.16574037843182624 0.020412132725625164];  % kg*mm^2
smiData.Solid(4).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(4).opacity = 1;
smiData.Solid(4).ID = "Steering_wheel_steering_column*:*Default";
