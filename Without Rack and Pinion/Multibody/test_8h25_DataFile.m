...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [443.36704264348765 137.60702895797726 116.08787005730052];  % mm
smiData.RigidTransform(8).angle = 1.8790970989790474;  % rad
smiData.RigidTransform(8).axis = [0.47897111022218214 -0.46779691265326273 0.74280059510248508];
smiData.RigidTransform(8).ID = "RootGround[Left_wheel-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(9).translation = [1165.3683433052572 104.13786247896175 107.338622840319];  % mm
smiData.RigidTransform(9).angle = 1.4116166514753252;  % rad
smiData.RigidTransform(9).axis = [-0.99995397943761177 -0.0033263345364395293 0.0089985835238570924];
smiData.RigidTransform(9).ID = "RootGround[right_wheel-1]";
