...
smiData.RigidTransform(1).translation = [-150.52661494087639 730.24941004317475 64.962154277991061];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-1.0164725520509137 6.304691397737372 -284.99804259358416];  % mm
smiData.RigidTransform(2).angle = 2.0046993236373685;  % rad
smiData.RigidTransform(2).axis = [-0.54404094799900293 -0.63877922148477329 -0.54404094799900238];
smiData.RigidTransform(2).ID = "F[Left_wheel-1:-:Tie_rod_components_new-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(3).translation = [16.749999999999932 90.486376465057546 -136.79205939419208];  % mm
smiData.RigidTransform(3).angle = 2.1004268969739925;  % rad
smiData.RigidTransform(3).axis = [0.57934694847684021 -0.57934694847684021 0.57333605030657797];
smiData.RigidTransform(3).ID = "B[right_wheel-1:-:Tie_rod_components_new-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [-1.0752173934463372 6.2949390486757579 1183.1534849394131];  % mm
smiData.RigidTransform(4).angle = 1.9996360639853135;  % rad
smiData.RigidTransform(4).axis = [-0.54193493372083645 -0.64234963627761577 -0.54193493372083623];
smiData.RigidTransform(4).ID = "F[right_wheel-1:-:Tie_rod_components_new-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [0 0 -5.0000000000001155];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [-158.68679035202757 1085.9179447584663 -163.94792738756246];  % mm
smiData.RigidTransform(6).angle = 2.0590841072465098;  % rad
smiData.RigidTransform(6).axis = [0.53820189812068209 -0.45676691884799714 0.70830974771310462];
smiData.RigidTransform(6).ID = "F[Steering_wheel_steering_column-1:-:Tie_rod_components_new-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [487.55044119725363 -118.80365343742722 -60.034331944938742];  % mm
smiData.RigidTransform(7).angle = 2.0111390008654912;  % rad
smiData.RigidTransform(7).axis = [-0.54570891357672957 -0.63500842466350815 0.54677790943789528];
smiData.RigidTransform(7).ID = "RootGround[Tie_rod_components_new-1]";
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 7.8898451039243689;  % kg
smiData.Solid(4).CoM = [0.32485987361900959 0.95553927955955764 403.58487685947614];  % mm
smiData.Solid(4).MoI = [1200383.3471504177 1200403.4536637708 2728.7713705479009];  % kg*mm^2
smiData.Solid(4).PoI = [743.50122149579283 1085.5586440926472 -60.51852330850032];  % kg*mm^2
smiData.Solid(4).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(4).opacity = 1;
smiData.Solid(4).ID = "Tie_rod_components_new*:*Default";
...
smiData.RevoluteJoint(1).Rz.Pos = 172.9218886524452;  % deg
smiData.RevoluteJoint(1).ID = "[Left_wheel-1:-:Tie_rod_components_new-1]";

smiData.RevoluteJoint(2).Rz.Pos = -88.11755243388879;  % deg
smiData.RevoluteJoint(2).ID = "[right_wheel-1:-:Tie_rod_components_new-1]";

smiData.RevoluteJoint(3).Rz.Pos = -167.57698423807301;  % deg
